...
```{r XINA analysis with HPRD, eval=FALSE}
...
You can draw PPI networks of all the XINA clusters using 'xina_plots' function easily.  PPI network plots will be stored in the sub-directory "xina_results/networks"
